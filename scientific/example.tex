...
\begin{document}
  \section{General Information}
    ...
    macors for quick writing of mathematical/scientific papers. To properly load them you should include the
  ...
  \begin{center}
    \begin{longtable}{Cl Cc Cc Cl Cc Cc}
      ...
      Laplace-Transformation & \lstinline|\lap{x}| & $\lap{x}$ & Z-Transformed & \lstinline|\zat{x}| & $\zat{x}$\\
      Fourier-Transformation & \lstinline|\frt| & $\frt$ & Fourier-Transformation & \lstinline|\fat{x}| & $\fat{x}$\\
      ...
      \hline
      Laplace-Transformation & \lstinline|\ltransf| & $\ltransf$ & Inverse Laplace-Transformation & 
        \lstinline|\Ltransf| & $\Ltransf$\\
      Z-Transformation & \lstinline|\ztransf| & $\ztransf$ & Inverse Z-Transformation & \lstinline|\Ztransf| &
        $\Ztransf$\\
      \hline
